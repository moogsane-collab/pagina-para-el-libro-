  ...
  <nav className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md z-50 border-b border-slate-100">
    <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        <a 
          href="#offer" 
          className="bg-red-600 text-white px-5 py-2.5 rounded-full text-sm font-bold hover:bg-red-700 transition-all shadow-lg shadow-red-100 hover:shadow-red-200"
        >
          DESCARGAR LIBRO
        </a>
      </div>
...
const Hero = () => (
  <section className="relative pt-32 pb-20 px-6 bg-gradient-to-b from-white to-slate-50 overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16 pt-10">
      ...
      <div className="flex-1 relative w-full max-w-md mx-auto group">
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-slate-400 text-lg max-w-2xl mx-auto">
          No es falta de voluntad, es un problema de percepción.
        </p>
      </div>
      
      <div className="space-y-6">
        {[
          { icon: Target, title: "Placeres Efímeros", text: "Buscas saciedad en compras o likes, pero el vacío regresa más grande cada vez." },
          { icon: Brain, title: "Nudos Emocionales", text: "Tus propios pensamientos son tus carceleros. Das vueltas en círculos sin encontrar la salida." },
...
const StorySection = () => (
  <section id="story" className="py-32 px-6 bg-white overflow-hidden">
    <div className="max-w-4xl mx-auto">
      ...
      <div className="relative p-12 md:p-16 bg-slate-50 rounded-[3rem] border border-slate-100 overflow-hidden">
        <Quote className="absolute top-8 left-8 w-24 h-24 text-slate-200 -z-0 opacity-40" />
        ...
        <div className="relative z-10 space-y-8 text-slate-600 text-lg leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center gap-12 border-t border-slate-200">
            ...
            <div className="ml-auto hidden md:flex items-center gap-4">
              ...
              <span className="text-xs font-bold text-slate-400 italic">Un propósito de sanación.</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="benefits" className="py-32 px-6 bg-slate-50 relative">
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-20">
        <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Tu Hoja de Ruta al Bienestar</h2>
        <p className="text-slate-500 max-w-2xl mx-auto text-lg">
          No es solo teoría, son herramientas aplicables hoy mismo.
        </p>
      </div>
      
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          { title: "Heridas de la Infancia", desc: "Cómo identificarlas y por qué siguen dictando tus decisiones sin que te des cuenta." },
          { title: "Biodescodificación Mental", desc: "Aprende a escuchar el mensaje real que tu cuerpo intenta enviarte." },
          { title: "Ocio Consciente", desc: "Cómo regenerar tu cerebro en una era saturada de dopamina artificial." },
          { title: "Metas vs Sueños", desc: "La distinción técnica que te salvará de la frustración perpetua." },
          { title: "Energías Internas", desc: "Equilibra tus polos masculino y femenino para una toma de decisiones coherente." },
          { title: "El Arte del 'No'", desc: "Herramientas de asertividad para proteger tu paz mental ante los demás." }
        ].map((benefit, i) => (
    ...
    <section id="offer" className="py-32 px-6 bg-white relative">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold text-slate-900 mb-6">Obtén tu Transformación</h2>
          <p className="text-slate-500 text-lg">Un sistema de dos pasos diseñado para tu bienestar.</p>
        </div>

        <div className="grid md:grid-cols-2 gap-12">
          {/* STEP 1: DONATION */}
          <div className="bg-slate-50 p-10 rounded-[2.5rem] border-2 border-slate-100 flex flex-col items-center text-center">
            <div className="w-14 h-14 bg-red-600 text-white rounded-full flex items-center justify-center text-xl font-black mb-8 shadow-lg shadow-red-200">
              1
            </div>
            ...
            <p className="text-slate-600 mb-10 leading-relaxed text-sm">
              Este libro es un regalo, pero tu donación me permite seguir dedicando mi vida a compartir este conocimiento con el mundo.
            </p>
            ...
            <p className="mt-8 text-[10px] text-slate-400 font-medium italic">
              *Tú eliges el valor. Tu apoyo es vital.
            </p>
          </div>
          ...
          <div className="bg-slate-900 p-10 rounded-[2.5rem] flex flex-col items-center text-center text-white shadow-2xl shadow-slate-300">
            <div className="w-14 h-14 bg-white text-slate-900 rounded-full flex items-center justify-center text-xl font-black mb-8">
              2
            </div>
            <h3 className="text-2xl font-bold mb-4">Descarga el Libro</h3>
            <p className="text-slate-400 mb-10 leading-relaxed text-sm">
              Accede al PDF inmediatamente. Sin registros. Haz clic debajo y comienza tu lectura ahora.
            </p>
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="group w-full py-4.5 bg-red-600 rounded-2xl font-black text-lg hover:bg-red-700 transition-all flex items-center justify-center gap-3 shadow-xl shadow-red-900/20"
            >
              DESCARGAR PDF <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </a>
            ...
            <div className="mt-8 flex flex-col items-center gap-2">
               ...
               <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Manual de Percepción Incluido</span>
            </div>
          </div>
        </div>

        <div className="mt-20 p-8 bg-green-50 rounded-3xl border border-green-100 flex flex-col md:flex-row items-center gap-6 max-w-2xl mx-auto">
          <ShieldCheck className="w-12 h-12 text-green-600 shrink-0" />
          <p className="text-green-800 text-sm font-medium leading-relaxed">
            <strong>Garantía de Valor:</strong> Si el libro no transforma tu visión del mundo, mi invitación a donar queda cancelada. Mi prioridad es tu crecimiento personal.
          </p>
        </div>
      </div>
    </section>
